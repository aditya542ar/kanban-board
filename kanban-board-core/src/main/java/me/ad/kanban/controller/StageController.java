...
public class StageController {
    ...
    @Autowired
    public StageController(CustomMessageProperties message, StageService StageService) {
    ...
    @PutMapping(path = "/{id}/update", consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    public StageDto updateStage(@PathVariable("id") String id, @RequestBody StageDto StageDto) {
        return stageService.updateStageById(id, StageDto);
    }

    @DeleteMapping(path = "/{id}")
    public void deleteStageById(@PathVariable("id") String id) {
