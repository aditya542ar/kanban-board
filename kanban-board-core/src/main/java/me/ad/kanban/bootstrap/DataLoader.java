...
public class DataLoader implements CommandLineRunner {
    ...
    public DataLoader(ProjectRepository projectRepository, UserRepository userRepository, StageRepository stageRepository,
                      TeamRepository teamRepository, TaskRepository taskRepository, PasswordEncoder passwordEncoder) {
    ...
    private void loadDemoData() {
        ...
        if(userRepository.findByUserId("john.d").isPresent() ||
                userRepository.findByUserId("foo.b").isPresent() ||
                userRepository.findByUserId("nick.f").isPresent()) {
            return;
        }
        ...
        owner.setPassword(passwordEncoder.encode("john.d"));
        ...
        foo.setLastName("Bar");
        foo.setPassword(passwordEncoder.encode("foo.b"));
        ...
        nick.setPassword(passwordEncoder.encode("nick.f"));
